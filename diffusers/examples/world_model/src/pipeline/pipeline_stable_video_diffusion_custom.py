...
from ..encoder.unified_encoder import EgoCondEncoder
...
class StableVideoDiffusionPipelineV2(DiffusionPipeline):
    ...
    def __call__(
        ...
        ego:List[torch.FloatTensor] = None,
        height: int = 576,
        width: int = 1024,
        ...
        layout_latents = self.layout_encoder(ego.to(image_embeddings.dtype))
        ...
        layout_latents = torch.cat([uncond_layout_latents,layout_latents],dim=0)
