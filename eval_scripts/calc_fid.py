...
def calculate_fid_given_paths(paths, batch_size, device, dims, num_workers=1, ckpt_path=''):
...
def save_fid_stats(paths, batch_size, device, dims, num_workers=1, ckpt_path=''):
    """Calculates the FID of two paths"""
...
def main():
    ...
    if args.save_stats:
        save_fid_stats(args.path, args.batch_size, device, args.dims, num_workers, args.inception_ckpt)
        return
